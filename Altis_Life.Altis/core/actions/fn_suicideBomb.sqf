...
[[0,format["%1 has set off their suicide vest ----- 10 seconds ----- RUN!!",player getVariable["realname",name player]]],"life_fnc_broadcast",true,false] spawn life_fnc_MP;sleep 2;
...
[[0,format["%1 went kablooey!!.",player getVariable["realname",name player]]],"life_fnc_broadcast",true,false] spawn life_fnc_MP;