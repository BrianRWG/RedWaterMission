...
if(side _robber != civilian) exitWith { hint "You are better than that...!" };// We do not want anyone but civilianz to rob the stations.
if (vehicle player != _robber) exitWith { hint "Get out of your vehicle!" };
if (currentWeapon _robber == "") exitWith { hint "HaHa, you do not threaten me! Get out of here you bum!!" };//is he trying to rob without a weapon? Lets taunt him a bit!
