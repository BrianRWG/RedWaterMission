...
switch (_side) do
{
	...
	{
		_markers = [
			["civ_spawn_1","Anthrakia","\a3\ui_f\data\map\MapControl\watertower_ca.paa"],
			["civ_spawn_2","Pyrgos","\a3\ui_f\data\map\MapControl\watertower_ca.paa"],
			["civ_spawn_3","Agios Dio.","\a3\ui_f\data\map\MapControl\watertower_ca.paa"],
			["civ_spawn_4","Place Holder","\a3\ui_f\data\map\MapControl\watertower_ca.paa"]
		];
